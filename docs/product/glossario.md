...
| RBAC + escopo | Papel (comandante/chefe/operador) + unidade: operador vê o seu, chefe vê o esquadrão, comandante vê global |
| ProblemDetail | Formato padrão de erro da API (RFC) |
